function  plotTotCost_NumRollouts(p,result, folder_name, class_name)
...
if ~p.disable_saving
    saveas(gcf, strcat(folder_name, '/', class_name, '_cost'), 'epsc')
    saveas(gcf, strcat(folder_name, '/', class_name, '_cost.fig'))
end
end
